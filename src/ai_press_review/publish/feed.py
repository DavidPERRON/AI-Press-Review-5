...
def _write_index(episodes: list[dict]) -> None:
    ...
    html = (
        ...
        "<style>"
        # Palette — DARK theme (navy continuous from banner, gold accents)
        ":root{"
        "--bg:#071028;"
        "--bg-soft:#0c1934;"
        "--bg-card:#0f1e3d;"
        ...
        # ── INTRO BLOCK (sous banner, bien visible) ──
        ...
        "margin:0 0 .4rem;line-height:1.35;font-weight:500}"
        ".intro .tagline-note{font-size:.78rem;color:var(--gold);text-align:center;margin:0 0 1.6rem;"
        "font-variant:small-caps;letter-spacing:.28em;opacity:.85}"
        # Subscribe pills on dark
        ...
        # Section divider
        ".sect-rule{display:block;width:60px;height:1px;background:var(--gold-soft);"
        "border:0;margin:0 auto 1.4rem;opacity:.6}"
        ...
        # How it works
        "#how-it-works{margin-top:3.2rem;padding-top:1.8rem;border-top:1px solid var(--rule)}"
        "#how-it-works h2{font-family:'EB Garamond',serif;font-weight:700;color:var(--gold);"
        "font-size:1.7rem;margin:0 0 .35rem;text-align:center;letter-spacing:.01em}"
        "#how-it-works .lead{text-align:center;font-style:italic;color:var(--ink-soft);"
        "margin:.25rem 0 1.7rem;font-size:1.05rem}"
        ".hiw-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));"
        "gap:1rem;margin:0 auto}"
        ".hiw-step{padding:1.2rem 1.35rem;background:var(--bg-card);"
        "border:1px solid var(--rule);border-radius:4px}"
        ".hiw-step strong{display:block;font-family:'EB Garamond',serif;font-weight:700;"
        "color:var(--gold);font-size:1.05rem;margin-bottom:.4rem;letter-spacing:.01em}"
        ".hiw-step span{color:var(--ink-soft);font-size:.95rem;line-height:1.55}"
        # Footer
        ...
        "</div>"
        "</header>"
        # ── INTRO (zone visible entre banner et episodes) ──
        "<section class='intro'>"
        ...
        "<a class='hiw-link' href='#how-it-works'>How it works &rarr;</a>"
        "</div>"
        "</section>"
        # ── PAGE ──
        "<div class='wrap'>"
